...
const HowItWorks = () => {
  ...
  return (
    <section className="bg-gray-100 rounded-2xl py-12 px-5 mt-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((step, i) => (
          <div
            key={i}
            className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl border border-gray-200 transition-all duration-300 text-center"
          >
